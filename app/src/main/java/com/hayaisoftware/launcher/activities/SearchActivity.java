...
import com.hayaisoftware.launcher.*;
import com.hayaisoftware.launcher.comparators.*;
import com.hayaisoftware.launcher.threading.*;
import com.hayaisoftware.launcher.util.*;
...
public class SearchActivity extends Activity
	...
	private void updateApps(final List<LaunchableActivity> updatedActivityInfos, boolean addToTrie) {
		...
		final String thisClassCanonicalName = getClass().getCanonicalName();
		for (LaunchableActivity launchableActivity : updatedActivityInfos) {
